...
VALUES
    ('Cursor', 'The AI Code Editor', 'AI_IDE', 'https://github.com/getcursor/cursor', 'ANYH'),
    ('Claude', 'A family of foundational AI models that can be used in a variety of applications.', 'AI_ASSISTANT', 'https://github.com/anthropics/claude-code', NULL),
    ('GitHub Copilot', 'Your AI pair programmer', 'CODE_COMPLETION', 'https://github.com/features/copilot', 'MSFT'),
    ('Replit', 'A collaborative browser-based IDE', 'CLOUD_IDE', 'https://github.com/replit', NULL),
    ('Augment', 'Your AI coding partner that helps you code faster and better.', 'AI_ASSISTANT', 'https://github.com/augmentcode', NULL),
    ('Zed', 'A high-performance, multiplayer code editor from the creators of Atom and Tree-sitter.', 'EDITOR', 'https://github.com/zed-industries/zed', NULL);
